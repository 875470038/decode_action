//Thu Sep 26 2024 01:28:14 GMT+0000 (Coordinated Universal Time)
...
async function getCoordinates() {
  return new Promise((joash, jabdiel) => {
    https.get("https://zh-hans.ipshu.com/my_info", fae => {
      ...
      fae.on("end", () => {
        const arayana = cheerio.load(arsalaan),
          jasia = arayana(".widget_box.p-xs.small"),
          dannita = jasia.find("li").eq(4).text().trim().split(":")[1],
          renee = jasia.find("li").eq(5).text().trim().split(":")[1];
        joash({
          latitude: dannita,
          longitude: renee
        });
